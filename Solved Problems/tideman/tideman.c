    ...
    for (int i=0; i<pair_count-1; i++)
    {
        for (int j=i+1; j<pair_count; j++)
        {
            ...
            if(preferences[pairs[i].winner][pairs[i].loser] - preferences[pairs[i].loser][pairs[i].winner] < preferences[pairs[j].winner][pairs[j].loser] - preferences[pairs[j].loser][pairs[j].winner])
            {
                ...
                pairs[j].winner = pairs[i].winner - pairs[j].winner;
                pairs[i].winner = pairs[i].winner - pairs[j].winner;
                pairs[i].loser += pairs[j].loser;
                pairs[j].loser = pairs[i].loser - pairs[j].loser;
                pairs[i].loser = pairs[i].loser - pairs[j].loser;
            }
        }
    }
    return;
